...
// ROLE : Admin Global
Route::middleware(['auth', 'role:admin_global'])->group(function () {
    // Fitur : Dashboard
    Route::get('/dashboard/admin-global', [App\Http\Controllers\AdminGlobalController::class, 'dashboard'])->name('admin-global.dashboard');
    ...
    // Fitur : Assign layanan to therapist
...
Route::middleware(['auth', 'role:admin_kolaborasi'])->group(function () {
    // Fitur : Dashboard
    ...
    Route::view('/booking/form/selesai', 'pages.booking.admin.form-selesai')->name('admin.booking.form-selesai');
...
Route::middleware(['auth', 'role:patient'])->group(function () {
    // Fitur : Pages
    Route::view('/landing/patient', 'pages.landing.patient')->name('patient.landing');
    Route::get('/therapist', [PagesController::class, 'TherapistListView'])->name('patient.therapist');

    // Fitur : Booking
    Route::get('/booking', [BookingController::class, 'index'])->name('patient.booking.index');
    Route::get('/booking/form', [BookingController::class, 'create'])->name('patient.booking.form');
    Route::post('/booking/form', [BookingController::class, 'store'])->name('patient.booking.store');
    Route::view('/booking/form-pasien/selesai', 'pages.booking.patient.form-selesai')->name('patient.booking.form-selesai');
    Route::get('/booking/patient/my-booking', [BookingController::class, 'myBooking'])->name('patient.booking.my-booking');
