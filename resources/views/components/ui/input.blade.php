    ...
    <input
        ...
        {{ $attributes->merge([
            'class' =>
                ...
                ($name && $errors->has($name) ? '!border-red-500 focus:!border-red-500 focus:ring-4 focus:!ring-red-500/20' : 'border-gray-200 focus:border-primary focus:ring-primary/20')
        ]) }}
    >
