    ...
    <div class="bg-white border-t border-slate-100 px-4 pb-6 pt-2 shadow-[0_-10px_40px_rgba(0,0,0,0.04)]">
        <div class="grid grid-cols-5 items-center">
            ...
            <a href="{{ route('therapist.jadwal') }}"   
                ...
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="{{ $active === 'jadwal' ? '2.5' : '2' }}">
                    <path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span class="text-[10px] font-bold uppercase tracking-tighter">Jadwal</span>
            </a>
            ...
            <a href="{{ route('therapist.booking') }}"
                class="flex flex-col items-center gap-1 py-2 transition-all active:scale-90
