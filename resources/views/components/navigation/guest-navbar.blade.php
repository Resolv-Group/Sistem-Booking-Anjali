    ...
    <div x-show="open" 
        ...
        <div class="grid grid-cols-3 gap-6">
            <a href="#" class="flex flex-col items-center gap-3 group">
                ...
                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center">Tentang Kami</span>
            </a>
            <a href="#" class="flex flex-col items-center gap-3 group">
                ...
                <span class="text-[10px] font-bold text-slate-500 uppercase tracking-widest text-center">Kontak</span>
            </a>
            <a href="#" class="flex flex-col items-center gap-3 group">
    ...
    <div class="bg-white border-t border-slate-100 px-4 pb-6 pt-2 shadow-[0_-10px_40px_rgba(0,0,0,0.04)]">
        <div class="grid grid-cols-5 items-center">
            ...
            <a href="{{ route('landing') }}"
                ...
                {{ $active === 'beranda' ? 'text-teal-600' : 'text-slate-400' }}">
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="{{ $active === 'beranda' ? '2.5' : '2' }}">
            ...
            <a href="{{ route('layanan') }}"   
                ...
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="{{ $active === 'layanan' ? '2.5' : '2' }}">
            ...
            <a href="{{ route('view.auth.login') }}"
                ...
                <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="{{ $active === 'booking' ? '2.5' : '2' }}">
