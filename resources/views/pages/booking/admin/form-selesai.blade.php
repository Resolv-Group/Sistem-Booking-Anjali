    ...
    <x-layouts.mobile-app class="bg-slate-50 min-h-screen">
        ...
        <div class="px-6 pt-10 pb-32 flex flex-col items-center">
            ...
            <div class="relative mb-8">
                ...
                <div
                    class="relative w-24 h-24 bg-teal-600 rounded-full flex items-center justify-center shadow-xl shadow-teal-900/20 border-4 border-white">
            ...
            <div class="text-center space-y-3 mb-10">
                ...
                <p class="text-base text-slate-500 font-medium leading-relaxed px-4">
                    Terima kasih telah mempercayakan Klinik Anjali. Tim kami akan segera meninjau dan mengonfirmasi bukti
                    transfer Anda.
                </p>
            </div>
            ...
            <div class="w-full bg-white rounded-[2rem] border border-slate-200 shadow-sm p-6 space-y-6 mb-8">
                ...
                <div class="flex flex-col items-center text-center">
                    <p class="text-[10px] font-semibold text-teal-600 uppercase tracking-[0.2em] mb-4">Pendaftaran Sukses
                    </p>
                    <div class="relative mb-3">
                        <div
                            class="w-16 h-16 bg-teal-50 rounded-full flex items-center justify-center border border-teal-100 shadow-inner">
                ...
                <div class="bg-slate-50 rounded-2xl p-5 space-y-4">
                    <div class="flex gap-4">
                        ...
                        <div>
                            <p class="text-[9px] font-semibold text-slate-400 uppercase tracking-widest mb-0.5">Status
                                Booking</p>
            ...
            <div class="w-full bg-slate-100 rounded-2xl p-6 space-y-5 mb-10">
                ...
                <div class="flex gap-4">
                    <div
                        class="w-8 h-8 shrink-0 bg-white rounded-lg flex items-center justify-center text-teal-600 shadow-sm">
