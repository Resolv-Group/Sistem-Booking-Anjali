        ...
        <div class="bg-white rounded-[2rem] p-6 shadow-sm border border-slate-100 group active:scale-[0.98] transition-all duration-300">
            <div class="flex flex-col items-center">
                ...
                <div class="text-center space-y-1.5">
                    ...
                    <p class="text-sm font-medium text-slate-400">{{ $namaCabang }}</p>
                    ...
                    <div class="flex items-center justify-center gap-1 mt-1">
                        ...
                        <span class="text-xs font-medium text-slate-400">({{ $reviews }} Review)</span>
                    </div>
                </div>
                ...
                <div class="mt-6 flex flex-col items-center">
                    ...
                    <h5 class="text-lg font-bold text-slate-800 leading-none">Rp {{ number_format($harga, 0, ',', '.') }}<span class="text-xs text-slate-400 font-medium ml-1">/ Sesi</span></h5>
                </div>

                {{-- Action --}}
                <a href="{{ route('patient.booking.form', ['therapist_id' => $t->id]) }}" class="mt-5 block text-center w-full py-4 bg-teal-700 text-white rounded-2xl text-sm font-bold uppercase tracking-widest shadow-xl shadow-teal-700/20 active:shadow-none active:translate-y-1 transition-all">
                    Buat Janji
                </a>
            </div>
        </div>
