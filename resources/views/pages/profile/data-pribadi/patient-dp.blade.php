            ...
            <form action="{{ route('patient.profile.update') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex flex-col items-center space-y-4">
                    <div class="relative">
                        <div
                            ...
                            <img :src="photoPreview" class="w-full h-full object-cover" alt="{{ $pasien->nama_pasien }}">
                        </div>
                ...
                <div class="bg-white p-6 rounded-[2.2rem] border border-slate-100 shadow-sm space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="tel" name="no_telp" value="{{ old('no_telp', $pasien->no_telp) }}"
                            class="w-full px-5 py-4 bg-slate-50 border-none rounded-2xl text-sm font-bold text-slate-700 outline-none">
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-[2.2rem] border border-slate-100 shadow-sm space-y-2">
                    ...
                    <textarea name="alamat" rows="3"
                        ...
                        placeholder="Contoh: Jl. Mawar No. 123, Surabaya...">{{ old('alamat', $pasien->alamat) }}</textarea>
                </div>
