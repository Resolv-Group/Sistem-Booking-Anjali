            ...
            <div
                ...
                @if (session('success'))
                    <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 4000)"
                        ...
                        <svg class="h-6 w-6 text-green-600 flex-shrink-0" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <div x-data="{ show: false }">
                        ...
                        <div class="mt-3 text-right">
                            <a href="{{ route('view.auth.forgot-password') }}"
                                class="text-sm font-bold text-primary hover:underline">Lupa Kata Sandi?</a>
                        </div>
                    </div>

                    <div class="pt-2">
                        <x-ui.button type="submit" placeholder="Login" name="login" value="login"
                            class="h-14 w-full rounded-2xl bg-primary text-lg font-bold shadow-lg shadow-primary/30" />
                    </div>
                </form>

                <div class="mt-10 text-center">
                    <p class="text-gray-500">Belum punya akun? <a href="{{ route('view.auth.register') }}"
                            class="font-bold text-primary hover:underline">Daftar Disini</a></p>
                </div>
            </div>
        </div>
    </x-layouts.mobile-app>
